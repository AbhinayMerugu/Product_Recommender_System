       ...
       if selected_product_name==None:
           ...
           for i in range(4):
             ...
             with col1:
                 ...
                 st.markdown(f'<a href="{link[recommended_products1[x]]}" style="color: black; text-decoration: none;">{names[recommended_products1[x]]}</a>',
                             unsafe_allow_html=True)
                 x+=1
             ...
             with col2:
                 ...
                 resized_img=img.resize((img_width,img_height))
                 st.image(resized_img)
                 st.markdown(f'<a href="{link[recommended_products1[x]]}" style="color: black; text-decoration: none;">{names[recommended_products1[x]]}</a>',unsafe_allow_html=True)
                 x+=1
